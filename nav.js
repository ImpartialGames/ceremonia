...
(function(){
  ...
  +".cnav-mcta{margin-top:20px;font-family:'Inter',sans-serif;font-size:11px;letter-spacing:.25em;text-transform:uppercase;border:1px solid var(--gold,#D4B896);color:var(--gold,#D4B896);padding:13px 32px}"
