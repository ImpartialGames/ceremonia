...
(function(){
  ...
  +"padding:16px 6vw;background:rgba(18,34,61,.82);backdrop-filter:blur(18px) saturate(150%);-webkit-backdrop-filter:blur(18px) saturate(150%);border-bottom:1px solid rgba(240,227,215,.12)}"
  ...
  +".cnav-brand span{font-family:'Poppins',sans-serif;font-size:10px;letter-spacing:.4em;text-transform:uppercase;color:var(--ivory,#F5F0E8)}"
  +".cnav-links{display:flex;align-items:center;gap:28px}"
  +".cnav-link{font-family:'Poppins',sans-serif;font-size:10px;letter-spacing:.24em;text-transform:uppercase;color:rgba(245,240,232,.65);transition:color .25s;white-space:nowrap}"
  +".cnav-link:hover{color:var(--gold,#f0e3d7)}"
  +".cnav-link[aria-current=page]{color:var(--gold,#f0e3d7)}"
  +".cnav-cta{font-family:'Poppins',sans-serif;font-size:10px;letter-spacing:.2em;text-transform:uppercase;white-space:nowrap;"
  +"border:1px solid var(--gold,#f0e3d7);color:var(--gold,#f0e3d7);padding:9px 20px;border-radius:30px;transition:background .3s,color .3s}"
  +".cnav-cta:hover{background:var(--gold,#f0e3d7);color:var(--navy,#12223d)}"
  +"#cnav .lang-switch{display:flex;align-items:center;gap:6px}"
  +"#cnav .lang-btn{background:none;border:none;cursor:pointer;font-family:'Poppins',sans-serif;font-size:10px;letter-spacing:.12em;color:rgba(245,240,232,.5);padding:2px;transition:color .25s}"
  +"#cnav .lang-btn:hover{color:var(--gold,#f0e3d7)}"
  +"#cnav .lang-btn.active{color:var(--gold,#f0e3d7);font-weight:600}"
  +"#cnav .lang-sep{color:rgba(240,227,215,.3);font-size:10px}"
  ...
  +"#cnav-menu{position:fixed;inset:0;z-index:99;background:rgba(14,25,46,.98);backdrop-filter:blur(22px) saturate(140%);-webkit-backdrop-filter:blur(22px) saturate(140%);"
  ...
  +".cnav-mlink{font-family:'Poppins',sans-serif;font-size:30px;font-weight:400;color:var(--ivory,#F5F0E8);letter-spacing:.02em;padding:8px 0;transition:color .25s}"
  +".cnav-mlink:hover,.cnav-mlink:active{color:var(--gold,#f0e3d7)}"
  +".cnav-mcta{margin-top:20px;font-family:'Poppins',sans-serif;font-size:10px;letter-spacing:.22em;text-transform:uppercase;border:1px solid var(--gold,#f0e3d7);color:var(--gold,#f0e3d7);padding:13px 32px;border-radius:30px;transition:background .3s,color .3s}"
  +".cnav-mcta:hover{background:var(--gold,#f0e3d7);color:var(--navy,#12223d)}"
  +"#cnav-menu .lang-switch{display:flex;align-items:center;gap:8px;margin-top:26px}"
  +"#cnav-menu .lang-btn{background:none;border:none;cursor:pointer;font-family:'Poppins',sans-serif;font-size:12px;letter-spacing:.18em;color:rgba(245,240,232,.5);padding:6px 4px;transition:color .25s}"
  +"#cnav-menu .lang-btn.active{color:var(--gold,#f0e3d7);font-weight:600}"
  +"#cnav-menu .lang-sep{color:rgba(240,227,215,.3);font-size:11px}"
