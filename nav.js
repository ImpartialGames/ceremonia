...
(function(){
  ...
  +"border:1px solid var(--gold,#f0e3d7);color:var(--gold,#f0e3d7);padding:9px 20px;border-radius:6px;transition:background .3s,color .3s}"
  ...
  +".cnav-mcta{margin-top:20px;font-family:'Poppins',sans-serif;font-size:10px;letter-spacing:.22em;text-transform:uppercase;border:1px solid var(--gold,#f0e3d7);color:var(--gold,#f0e3d7);padding:13px 32px;border-radius:6px;transition:background .3s,color .3s}"
