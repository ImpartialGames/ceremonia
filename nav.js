...
(function(){
  ...
  +".cnav-mcta{margin-top:20px;font-family:'Poppins',sans-serif;font-size:10px;letter-spacing:.22em;text-transform:uppercase;border:1px solid var(--gold,#D4B896);color:var(--gold,#D4B896);padding:13px 32px;border-radius:30px;transition:background .3s,color .3s}"
